...
export class ExamenService {
  ...
  getParticipationsByExamen(
    examId: number
  ): Observable<ParticipationExamenDTO[]> {
    return this.http.get<ParticipationExamenDTO[]>(
      `${this.apiUrl}/${examId}/participations`,
      {
        headers: this.getHeaders(),
      }
    );
  ...
  gradeParticipation(
    request: ExamenNotationRequest
  ): Observable<ParticipationExamenDTO> {
    return this.http.post<ParticipationExamenDTO>(
      `${this.apiUrl}/note`,
      request,
      {
        headers: this.getHeaders(),
